...
import { postApiV1PunchTimingsPunchTimingIdPunchBreaksCreateFields } from './punch_breaks/create/description';
import { putApiV1PunchTimingsPunchTimingIdPunchBreaksIdUpdateFields } from './punch_breaks/update/description';
import { postApiV1PunchTimingsShiftCreateCreateFields } from './shift_create/create/description';
import { postApiV1PunchTimingsStartCreateFields } from './start/create/description';
import { getApiV1PunchTimingsFetchLocationsPositionsGetAllFields } from './fetch_locations_positions/getAll/description';
import { getApiV1PunchTimingsPunchTimeGetAllFields } from './punch_time/getAll/description';
import { getApiV1PunchTimingsRecordGetAllFields } from './record/getAll/description';
import { getApiV1PunchTimingsGetAllFields } from './getAll/description';
import { putApiV1PunchTimingsIdUpdateFields } from './update/description';
