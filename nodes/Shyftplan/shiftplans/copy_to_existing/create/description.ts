...
export const postApiV1ShiftplansShiftplanIdCopyToExistingCreateFields: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				operation: ['postApiV1ShiftplansShiftplanIdCopyToExisting'],
				resource: ['shiftplans'],
			},
		},
	},
	{
		displayName: 'Existing Shiftplan_ID',
		name: 'existing_shiftplan_id',
		type: 'number',
		default: '',
		placeholder: '',
		description: 'Enter Existing Shiftplan ID',
		required: true,
		displayOptions: {
			show: {
				operation: ['postApiV1ShiftplansShiftplanIdCopyToExisting'],
