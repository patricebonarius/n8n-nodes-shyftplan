...
export async function shiftplansExecute(
  ...
  if (operation === "postApiV1ShiftplansAssignEmploymentsToOpenShifts") {
    responseData =
      await postApiV1ShiftplansAssignEmploymentsToOpenShiftsCreateExecute(
        node,
        operation,
        i
      );
  ...
  if (operation === "deleteApiV1ShiftplansId") {
    responseData = await deleteApiV1ShiftplansIdDeleteExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "postApiV1ShiftplansIdAssignRotation") {
    responseData = await postApiV1ShiftplansIdAssignRotationCreateExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "postApiV1ShiftplansIdPublish") {
    responseData = await postApiV1ShiftplansIdPublishCreateExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "getApiV1ShiftplansShiftplanIdNotifications") {
    responseData =
      await getApiV1ShiftplansShiftplanIdNotificationsGetAllExecute(
        node,
        operation,
        i
      );
  ...
  if (operation === "postApiV1ShiftplansShiftplanIdNotificationsMessages") {
    responseData =
      await postApiV1ShiftplansShiftplanIdNotificationsMessagesCreateExecute(
        node,
        operation,
        i
      );
  ...
  if (operation === "postApiV1ShiftplansShiftplanIdMessages") {
    responseData = await postApiV1ShiftplansShiftplanIdMessagesCreateExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "postApiV1ShiftplansShiftplanIdCopyToExisting") {
    responseData =
      await postApiV1ShiftplansShiftplanIdCopyToExistingCreateExecute(
        node,
        operation,
        i
      );
  ...
  if (operation === "postApiV1ShiftplansShiftplanIdCopy") {
    responseData = await postApiV1ShiftplansShiftplanIdCopyCreateExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "postApiV1ShiftplansShiftplanIdDayNotes") {
    responseData = await postApiV1ShiftplansShiftplanIdDayNotesCreateExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "getApiV1ShiftplansShiftplanIdDayNotes") {
    responseData = await getApiV1ShiftplansShiftplanIdDayNotesGetAllExecute(
      node,
      operation,
      i
    );
  ...
  if (operation === "deleteApiV1ShiftplansShiftplanIdDayNotesId") {
    responseData =
      await deleteApiV1ShiftplansShiftplanIdDayNotesIdDeleteExecute(
        node,
        operation,
        i
      );
  ...
  if (operation === "putApiV1ShiftplansShiftplanIdDayNotesId") {
    responseData = await putApiV1ShiftplansShiftplanIdDayNotesIdUpdateExecute(
      node,
      operation,
      i
    );
