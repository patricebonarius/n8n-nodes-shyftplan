...
export async function deleteApiV1EmploymentsIdPaygradesPaygradeIdDeleteExecute(
  ...
  const update_paygrades = node.getNodeParameter(
    "update_paygrades",
    i
  ) as boolean;
  ...
  const myOptions: IHttpRequestOptions = {
    url:
      credentials.domain + "/api/v1/" + "employments/" + id + "paygrades/" + id,
    method: "DELETE",
    body: data,
  };
