import { IDataObject, IExecuteFunctions, IHttpRequestOptions } from 'n8n-workflow';
        ...
        export async function getApiV1EmploymentsIdNotificationsGetAllExecute(node: IExecuteFunctions, operation: string, i: number) {
...
company_id,
        ...
        const myOptions: IHttpRequestOptions = {
            url: credentials.domain + "/api"+ "/v1"+ "/employments"+ "/" +id+ "/notifications",
            method: 'GET',
            headers: header,
            qs: data,
            arrayFormat: 'repeat',
