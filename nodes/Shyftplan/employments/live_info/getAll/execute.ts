import { IDataObject, IExecuteFunctions, IHttpRequestOptions } from 'n8n-workflow';
        ...
        export async function getApiV1EmploymentsIdLiveInfoGetAllExecute(node: IExecuteFunctions, operation: string, i: number) {
...
id,
        ...
        const myOptions: IHttpRequestOptions = {
            url: credentials.domain + "/api"+ "/v1"+ "/employments"+ "/" +id+ "/live_info",
            method: 'GET',
            headers: header,
            qs: data,
            arrayFormat: 'repeat',
