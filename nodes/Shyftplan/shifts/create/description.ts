...
export const postApiV1ShiftsCreateFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		placeholder: '',
		description: 'Enter ID of an Shiftplan',
		required: true,
		displayOptions: {
			show: {
				operation: ['postApiV1Shifts'],
	...
	},
	{
		...
		placeholder: '',
		description:
			'Enter ID of LocationsPosition - Location needs to match the location of the shiftplan',
		required: true,
		displayOptions: {
			show: {
				operation: ['postApiV1Shifts'],
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				placeholder: '',
				description:
					'Enter Break duration in minutes (Required unless untimed_break_time is present)',
			},
			{
			...
			},
			{
				...
				default: '',
				placeholder: '',
				description: 'Enter Array of assignment group IDs',
			},
			{
				...
				default: '',
				placeholder: '',
				description: 'Enter Array of shift_rotation_group group IDs',
			},
			{
