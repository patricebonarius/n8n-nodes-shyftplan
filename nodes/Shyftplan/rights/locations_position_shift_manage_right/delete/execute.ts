...
export async function deleteApiV1RightsLocationsPositionShiftManageRightDeleteExecute(
	...
	const myOptions: IHttpRequestOptions = {
		url: credentials.domain + '/api' + '/v1' + '/rights' + '/locations_position_shift_manage_right',
		method: 'DELETE',
		body: data,
		arrayFormat: 'repeat',
	};
