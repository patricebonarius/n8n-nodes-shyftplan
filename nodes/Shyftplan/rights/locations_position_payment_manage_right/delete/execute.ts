...
export async function deleteApiV1RightsLocationsPositionPaymentManageRightDeleteExecute(
	...
	const myOptions: IHttpRequestOptions = {
		url:
			credentials.domain + '/api' + '/v1' + '/rights' + '/locations_position_payment_manage_right',
		method: 'DELETE',
		body: data,
		arrayFormat: 'repeat',
	};
