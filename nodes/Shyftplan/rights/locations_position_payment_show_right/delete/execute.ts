...
export async function deleteApiV1RightsLocationsPositionPaymentShowRightDeleteExecute(
	...
	const myOptions: IHttpRequestOptions = {
		url: credentials.domain + '/api' + '/v1' + '/rights' + '/locations_position_payment_show_right',
		method: 'DELETE',
		body: data,
		arrayFormat: 'repeat',
	};
