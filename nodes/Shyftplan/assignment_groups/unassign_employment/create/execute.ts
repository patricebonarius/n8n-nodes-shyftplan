import { IDataObject, IExecuteFunctions, IHttpRequestOptions } from 'n8n-workflow';
        ...
        export async function postApiV1AssignmentGroupsIdUnassignEmploymentCreateExecute(node: IExecuteFunctions, operation: string, i: number) {
...
end_date,
        ...
        const myOptions: IHttpRequestOptions = {
            url: credentials.domain + "/api"+ "/v1"+ "/assignment_groups"+ "/" +id+ "/unassign_employment",
            method: 'POST',
            body: data,
            arrayFormat: 'repeat',
        };
