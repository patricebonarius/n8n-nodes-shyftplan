import { INodeProperties } from 'n8n-workflow';import { getApiV1EmployeeEvaluationsStaffShiftIdGetFields } from './get/description';import { postApiV1EmployeeEvaluationsStaffShiftIdCreateFields } from './create/description';import { deleteApiV1EmployeeEvaluationsStaffShiftIdDeleteFields } from './delete/description';import { postApiV1EmployeeEvaluationsStaffShiftIdAcceptCreateFields } from './accept/create/description';import { deleteApiV1EmployeeEvaluationsEvaluationIdTagsEvaluationTagIdDeleteFields } from './tags/delete/description';import { postApiV1EmployeeEvaluationsEvaluationIdTagsCreateFields } from './tags/create/description';import { getApiV1EmployeeEvaluationsEvaluationIdTagsGetAllFields } from './tags/getAll/description';import { putApiV1EmployeeEvaluationsStaffShiftIdPaymentsPaymentIdUpdateFields } from './payments/update/description';import { getApiV1EmployeeEvaluationsStaffShiftIdPaymentsPaymentIdGetFields } from './payments/get/description';import { postApiV1EmployeeEvaluationsStaffShiftIdPaymentsCreateFields } from './payments/create/description';import { getApiV1EmployeeEvaluationsStaffShiftIdPaymentsGetAllFields } from './payments/getAll/description';import { deleteApiV1EmployeeEvaluationsStaffShiftIdEvaluationBreakEvaluationBreakIdDeleteFields } from './evaluation_break/delete/description';import { putApiV1EmployeeEvaluationsStaffShiftIdEvaluationBreakEvaluationBreakIdUpdateFields } from './evaluation_break/update/description';import { postApiV1EmployeeEvaluationsStaffShiftIdEvaluationBreakCreateFields } from './evaluation_break/create/description';
...
export const employee_evaluationsOps: INodeProperties[] = [

        {
            ...
            options: [{
                    ...
                    action: 'Delete employee evaluations staff shift by ID evaluation break evaluation break id',
                }, {
    ...
    default: 'employee_evaluations_getAll',
