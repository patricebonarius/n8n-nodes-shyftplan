import { IDataObject, IExecuteFunctions, IHttpRequestOptions } from 'n8n-workflow';
        ...
        export async function putApiV1EmployeeEvaluationsStaffShiftIdEvaluationBreakEvaluationBreakIdUpdateExecute(node: IExecuteFunctions, operation: string, i: number) {
...
evaluation_break_id,
        ...
        const myOptions: IHttpRequestOptions = {
            url: credentials.domain + "/api"+ "/v1"+ "/employee_evaluations"+ "/" +staff_shift_id+ "/evaluation_break"+ "/" +evaluation_break_id,
            method: 'PUT',
            body: data,
        };
