import { IDataObject, IExecuteFunctions, IHttpRequestOptions } from 'n8n-workflow';
        ...
        export async function getApiV1AbsencesEmploymentsIdCarryOverInfoGetAllExecute(node: IExecuteFunctions, operation: string, i: number) {
...
ends_at,
        ...
        const myOptions: IHttpRequestOptions = {
            url: credentials.domain + "/api"+ "/v1"+ "/absences"+ "/employments"+ "/" +id+ "/carry_over_info",
            method: 'GET',
            headers: header,
            qs: data,
        };
